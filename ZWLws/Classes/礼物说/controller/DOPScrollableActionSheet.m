...
- (instancetype)initWithActionArray:(NSArray *)actions {
    ...
    if (self) {
        ...
        _dimBackground.backgroundColor = [UIColor blackColor];
        ...
        for (int i = 0; i < rowCount; i++) {
            if ([_actions[i] isKindOfClass:[NSString class]]) {
                ...
                //actions array
                UIScrollView *rowContainer = [[UIScrollView alloc] initWithFrame:CGRectMake(0, y, Screen_Width, 90)];
          //      rowContainer.backgroundColor = [UIColor greenColor];
                ...
                rowContainer.contentSize = CGSizeMake(Screen_Width, 90);
                ...
                for (int j = 0; j < items.count; j++) {
                    ...
                    button.frame = CGRectMake(x, 0, (Screen_Width - 4*horizontalMargin)/3, 60);
             ...
             //       button.backgroundColor = [UIColor redColor];
                    ...
                    UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(x, 60, (Screen_Width - 4*horizontalMargin)/3, 30)];
                    label.text = action.actionName;
                    label.font = [UIFont systemFontOfSize:13.0];
                    label.textAlignment = NSTextAlignmentCenter;
                    [rowContainer addSubview:label];
                    x = x + (Screen_Width - 4*horizontalMargin)/3 + horizontalMargin;
                  //  NSLog(@" x == %lf",x);
...
- (void)show {
    ...
    [UIView animateWithDuration:0.2 animations:^{
        self.dimBackground.backgroundColor = [UIColor colorWithWhite:0.0 alpha:0.7];
